...
BenchmarkJS.prototype = {
	...
	,requestArchivedData: function() {
		...
		request.onError = function(msg) {
			console.log("srcPages/BenchmarkJS.hx:120:","failed to download Haxe 3 data: " + msg);
		};
		request.request();
		...
		request1.onError = function(msg1) {
			console.log("srcPages/BenchmarkJS.hx:132:","failed to download Haxe 4 data: " + msg1);
		};
		request1.request();
	}
		...
		if(target == "NodeJS") {
			...
			case 0:
				if(this.withHaxe3) {
					...
					data1.datasets = [haxe4Dataset,haxe4ES6Dataset];
				}
				break;
			case 1:
				if(this.withHaxe3) {
					...
					data1.datasets = [haxe4SMADataset,haxe4ES6SMADataset];
				}
				break;
			case 2:
				if(this.withHaxe3) {
					...
					data1.datasets = [haxe4Dataset,haxe4SMADataset,haxe4ES6Dataset,haxe4ES6SMADataset];
				}
				break;
			}
		}
	...
	request: function(post) {
		...
		var onreadystatechange = function(_) {
			...
			if(s != null && s >= 200 && s < 400) {
				...
				_gthis.req = null;
				var onreadystatechange2 = r.response != null ? haxe_io_Bytes.ofData(r.response) : null;
				_gthis.responseBytes = onreadystatechange2;
				...
				default:
					_gthis.req = null;
					var onreadystatechange3 = r.response != null ? haxe_io_Bytes.ofData(r.response) : null;
					_gthis.responseBytes = onreadystatechange3;
					_gthis.onError("Http Error #" + r.status);
				}
			}
		};
		...
		if(uri != null) {
			...
			while(_g2 < _g3.length) {
				...
				var s1 = p.name;
				var value = (uri == null ? "null" : Std.string(uri)) + encodeURIComponent(s1) + "=";
				var s2 = p.value;
